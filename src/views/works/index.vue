...
import canvasDemo from '@/assets/demo/canvas-loading-1.png'
import cssLoadingDemo from '@/assets/demo/css-google-loader.png'
import canvasClockDemo from '@/assets/demo/canvas-clock.png'
import vueWatchDemo from '@/assets/demo/vue-watch-dep.png'
import cssFlexDemo from '@/assets/demo/css-flex.png'
import cssStackDemo from '@/assets/demo/css-img-stack.png'
import echartsPieDemo from '@/assets/demo/echarts-pie.png'
...
.card-list {
  ...
  @count-per-row: 5;
  & > .card-item {
    width: calc((100% - @gutter * (@count-per-row - 1)) / @count-per-row);
    margin-bottom: 15px;
    transition: all .2s;
